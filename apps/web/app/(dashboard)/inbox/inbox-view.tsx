            ...
            return (
              ...
              >
                    ...
                    {m.quotedMessage && (
                      <div
                        className={`mb-1.5 rounded border-l-2 pl-2 py-1 ${
                          m.direction === "OUTBOUND" ? "border-white/50 bg-surface/10" : "border-accent/50 bg-black/5"
                        }`}
                      >
                ...
                {hasReaction && (
                  ...
                  >
                    {theirReaction && (
                      <span className="rounded-full border border-neutral-200 bg-surface shadow-sm text-xs leading-none px-1 py-0.5">
                        {theirReaction.emoji}
                      </span>
                    )}
                    {myReaction && (
...
function ForwardModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div className="bg-surface rounded-lg w-full max-w-sm shadow-lg flex flex-col max-h-[80vh]">
...
function ContactPanel({
  ...
  return (
    <div className="fixed inset-y-0 right-0 z-40 w-72 md:static md:z-auto shrink-0 border-l border-neutral-200 bg-surface p-4 flex flex-col gap-4 overflow-y-auto">
    ...
    <div className="flex items-center gap-1.5 flex-wrap">
      ...
      {options.length > 0 && (
        <select
          ...
          className="text-[11px] rounded-full border border-neutral-300 bg-surface px-2 py-0.5 text-neutral-500 focus:outline-none focus:ring-1 focus:ring-accent"
        >
